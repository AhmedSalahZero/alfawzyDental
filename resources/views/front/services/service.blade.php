    ...
    <section class="top-managements section-bg section-py">
        <div class="res-container">
            ...
            <div class="top-managemet-element mb-24">
                ...
                <div
                    class="doctors-cards element-internal-padding grid  grid-cols-1 sm:grid-cols-2 md:grid-cols-3  justify-items-center items-center">
                    @foreach($category->services as $service)
                        <x-cards.flip-card>
                            <x-slot name="front__face">
                                <a href="#">
                                    <img class="h-[280px] object-cover w-[310px] md:w-[342px] rounded-[32px] mx-auto"
