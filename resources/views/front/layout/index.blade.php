        ...
        <div class="header__menu z-[5] flex justify-between
            ...
            <div class="logo__container flex flex-col gap-20">
                <a href="{{ route('home.index') }}" class="logo__image max-w-[]">
                    <img class="w-[40px]   lg:h-[75px] lg:w-auto" src="{{ get_file($settings->logo_header) }}"
                         alt="{{ env('APP_NAME	') }}">
                </a>
                ...
                <li class="group/li relative " x-data="{isOpen:false}"
                    ...
                    <ul x-cloak x-show="isOpen" x-transition:enter="transition ease-out duration-100"
                        ...
                        @foreach($serviceCategories as $category)
                            <x-links.sub-menu-item :link="route('web_category_services.index',$category->id)"
                ...
                <div class="hidden md:block icons  z-[12]">
                    <ul class="flex  flex-col space-y-7 ">
                        ...
                        'link'=>$settings->tiktok,
                            ...
                            <x-links.social-links :iconName="$iconName" :iconClass="$iconArr['icon']"
                                                  :iconLink="$iconArr['link']"></x-links.social-links>
                        @endforeach
                    </ul>
