<section class="section-dentinal-card section bg-[#CECECE] h-[380px] relative mt-80 ">
    <div class="res-container ">
        ...
        <div
            class="rounded-none   md:rounded-[40px] text-center md:text-left left-1/2 -translate-x-1/2 md:translate-x-0 w-full md:w-auto dential-card-content bg-white shadow-sm -mt-6   md:max-w-[422px] lg:max-w-[622px] absolute md:left-auto  -top-full md:top-0  md:-translate-y-1/2 right:0 md:right-[5%] py-10 md:py-10 px-5 md:px-10">
            ...
            <div class="columns-1 md:columns-2 gap-8 mb-6 space-y-10 md:space-y-0">
            ...
            <a href="#" class="whatsapp__container inline-flex items-center justify-center social-whatsapp">
