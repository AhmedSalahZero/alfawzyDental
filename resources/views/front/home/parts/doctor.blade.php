<section class=" @if(!isset($mt)) space-between-sections-y mt-52 @else shadow-sm mb-24 pb-5  mt-0 @endif  lg:mt-0">

    <div class="res-container @if(!isset($mt)) mt-96 md:mt-36 @else  @endif ">
        <div class="online-consultings relative text-left @if(!isset($mt))  mt-24 @else  @endif mb-60  lg:my-0 flex justify-between  md:text-left items-center flex-col md:flex-row  gap-12 lg:gap-20 ">
            ...
            <div class="online-consulting hidden md:block scroll-from-right-to-left @if(isset($mt))  relative top-[40px]  @endif ">
