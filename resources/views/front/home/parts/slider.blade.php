            ...
            <div
                class="min-services  flex flex-col lg:flex-row space-x-0  lg:space-x-5 space-y-5 lg:space-y-0  items-center justify-between    ">
                    ...
                    <a target="_blank" href="{{ getWhatsappApi($settings->whatsapp) }}"
                        class="min-service scroll-from-left-to-right grow flex items-center justify-center h-[190px] w-full lg:w-auto rounded-2xl shadow-md">
                ...
                <a href="{{route('dental.tourism.index')}}"
                   class="min-service grow scroll-from-bottom-to-up flex items-center justify-center h-[190px] w-full lg:w-auto rounded-2xl shadow-md">
