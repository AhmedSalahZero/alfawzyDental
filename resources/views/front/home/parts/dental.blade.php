    ...
    <div class="res-container">
        <div
            ...
            <img src="{{ get_file($dental->image) }} " alt=""
                 class="absolute rounded-[32px] scroll-from-bottom-to-up max-w-[100%] sm:max-w-[90%] md:max-w-[65%] max-h-[500px] left-1/2 -translate-x-1/2 object-cover bottom-0 translate-y-1/2">
        </div>
    </div>
</section>
