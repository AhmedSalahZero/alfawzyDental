...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('categoryMembers.update',$row->id)}}">
    @csrf
    @method('PUT')
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="title" required type="text" class="form-control form-control-solid" placeholder="" name="header_show" value="{{$row->header_show}}"/>
        </div>
