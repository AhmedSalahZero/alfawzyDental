...
<form id="form" enctype="multipart/form-data" method="POST" action="{{route('reviews.store')}}">
    @csrf
    <div class="row g-4">
        ...
        <div class="d-flex flex-column mb-7 fv-row col-sm-6">
            ...
            <!--end::Label-->
            <input id="rate" min="1" max="5" required type="number" class="form-control form-control-solid" placeholder="" name="rate" value=""/>
        </div>
