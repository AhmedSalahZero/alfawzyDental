...
@section('content')
    <div class="card">
        <div class="card-header d-flex align-items-center">
            <h5 class="card-title mb-0 flex-grow-1">Service Categories </h5>


                <div>
                    <button id="addBtn" class="btn btn-primary">Add a Service Category</button>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> Service Category </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
...
@section('js')
        ...
        $('#sortTable').sortable({
            stop: function () {
                ...
                $('.sortClass').each(function (index) {
                    ...
                    $.post("{{route('admin.updateServiceCategoryRank')}}", method, function (data) {
                        // console.log(data)
    ...
    @include('Admin.layouts.inc.ajax',['url'=>'serviceCategories'])
