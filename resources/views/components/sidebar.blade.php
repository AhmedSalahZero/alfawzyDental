<div  x-show="showSideBar" class="hidden md:flex bg-white flex-col h-full p-3 w-60 dark:bg-gray-900 dark:text-gray-100   right-0 z-[99999999999999999] top-0  bottom-0 fixed">
	<div class="space-y-3">
...
{{--			<input type="search" name="Search" placeholder="Search..." class="w-full py-2 pl-10 text-sm dark:border-transparent rounded-md focus:outline-none dark:bg-gray-800 dark:text-gray-100 focus:dark:bg-gray-900">--}}
		...
		<div class="flex-1">
			<ul class="pt-2 pb-4 space-y-1 text-sm">
				<li class="rounded-sm">
					<a rel="noopener noreferrer" href="{{route('home.index')}}" class="flex items-center p-2 space-x-3 rounded-md">
				...
				<li class="rounded-sm">
					<a rel="noopener noreferrer" href="{{route('web_about.index')}}" class="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
							<path d="M479.6,399.716l-81.084-81.084-62.368-25.767A175.014,175.014,0,0,0,368,192c0-97.047-78.953-176-176-176S16,94.953,16,192,94.953,368,192,368a175.034,175.034,0,0,0,101.619-32.377l25.7,62.2L400.4,478.911a56,56,0,1,0,79.2-79.195ZM48,192c0-79.4,64.6-144,144-144s144,64.6,144,144S271.4,336,192,336,48,271.4,48,192ZM456.971,456.284a24.028,24.028,0,0,1-33.942,0l-76.572-76.572-23.894-57.835L380.4,345.771l76.573,76.572A24.028,24.028,0,0,1,456.971,456.284Z"></path>
						</svg>
						<span>About Us</span>
				...
				<li class="rounded-sm">
					<a rel="noopener noreferrer" href="{{route('web_services.index')}}" class="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
				...
				<li class="rounded-sm">
					<a rel="noopener noreferrer" href="{{route('web_partners.index')}}" class="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
				...
				<li class="rounded-sm dark:bg-gray-800 dark:text-gray-50">
					<a rel="noopener noreferrer" href="{{route('web_gallery.index')}}" class="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
				...
				<li class="rounded-sm">
					<a rel="noopener noreferrer" href="{{route('dental.tourism.index')}}" class="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
				...
				<li class="rounded-sm">
					<a rel="noopener noreferrer" href="{{route('web_contacts.index')}}" class="flex items-center p-2 space-x-3 rounded-md">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-5 h-5 fill-current dark:text-gray-400">
